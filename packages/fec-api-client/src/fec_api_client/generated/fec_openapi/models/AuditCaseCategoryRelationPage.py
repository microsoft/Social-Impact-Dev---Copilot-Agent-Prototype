...
class AuditCaseCategoryRelationPage(BaseModel):
    """
    Strongly-typed model class for AuditCaseCategoryRelationPage
    ...
    @property
    def results(self) -> List['AuditCaseCategoryRelation']:
        """Get results"""
        return self._data.get("results")
    @results.setter
    def results(self, value: List['AuditCaseCategoryRelation']):
        """Set results"""
