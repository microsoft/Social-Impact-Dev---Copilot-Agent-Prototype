...
class AuditCaseCategoryRelation(BaseModel):
    """
    Strongly-typed model class for AuditCaseCategoryRelation
    ...
    @property
    def sub_category_list(self) -> List['AuditCaseSubCategory']:
        """Get sub_category_list"""
        return self._data.get("sub_category_list")
    @sub_category_list.setter
    def sub_category_list(self, value: List['AuditCaseSubCategory']):
