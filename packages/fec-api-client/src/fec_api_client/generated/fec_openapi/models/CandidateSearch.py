...
class CandidateSearch(BaseModel):
    """
    Strongly-typed model class for CandidateSearch
    ...
    @property
    def principal_committees(self) -> List['PrincipalCommittee']:
        """Get principal_committees"""
        return self._data.get("principal_committees")
    @principal_committees.setter
    def principal_committees(self, value: List['PrincipalCommittee']):
        """Set principal_committees"""
        self._data["principal_committees"] = value
