...
class CandidateTotalsDetailPresidential(BaseModel):
    """
    Strongly-typed model class for CandidateTotalsDetailPresidential
    ...
    @property
    def loans_received(self) -> float:
        """Get loans_received"""
        return self._data.get("loans_received")
    @loans_received.setter
    def loans_received(self, value: float):
        """Set loans_received"""
        self._data["loans_received"] = value

    @property
    def loans_received_from_candidate(self) -> float:
        """Get loans_received_from_candidate"""
        return self._data.get("loans_received_from_candidate")
    @loans_received_from_candidate.setter
    def loans_received_from_candidate(self, value: float):
        """Set loans_received_from_candidate"""
        self._data["loans_received_from_candidate"] = value
    ...
    @property
    def other_loans_received(self) -> float:
        """Get other_loans_received"""
        return self._data.get("other_loans_received")
    @other_loans_received.setter
    def other_loans_received(self, value: float):
        """Set other_loans_received"""
        self._data["other_loans_received"] = value
    ...
    @property
    def transfers_from_affiliated_committee(self) -> float:
        """Get transfers_from_affiliated_committee"""
        return self._data.get("transfers_from_affiliated_committee")
    @transfers_from_affiliated_committee.setter
    def transfers_from_affiliated_committee(self, value: float):
        """Set transfers_from_affiliated_committee"""
        self._data["transfers_from_affiliated_committee"] = value
